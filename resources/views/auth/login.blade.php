        ...
        <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
            ...
            <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                ...
                <div class="w-lg-500px p-10">
                    <!--begin::Form-->
                    <form class="form w-100 ajax-form" novalidate="novalidate" action="{{ route('login.check') }}" method="post">
                        @csrf
                        <!--begin::Heading-->
                        ...
                        <!--end::Input group=-->
                        <div class="fv-row mb-3 password-box">
                            <!--begin::Password-->
                        ...
                        <div class="fv-row mb-3">
                            ...
                            <label class="form-check form-switch form-check-custom form-check-solid">
                                ...
                                <span class="form-check-label fw-semibold text-muted">Remenber me</span>
                            </label>
                            <!--end::remember-->
                        </div>
                        <!--end::Wrapper-->
                        ...
                        <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
                            <div></div>
                            <!--begin::Link-->
                            <a href="{{ route('forgot.password.index') }}" class="link-primary">Forgot Password ?</a>
                            <!--end::Link-->
                        </div>
                        <!--end::Wrapper-->
                        <!--begin::Submit button-->
