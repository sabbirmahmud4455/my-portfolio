    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-body py-3">
            <div class="row">
                <div class="col-md-12">
                    <!--begin::Form-->
                    <form class="form ajax-form" action="{{ route('role.edit', ['id' => encrypt($role->id)]) }}" autocomplete="off" method="post">
                        @csrf
                        <!--begin::Scroll-->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="fv-row mb-10">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <select name="is_active" class="form-select form-select-lg form-select-solid select2">
                                            <option disabled>Secect Status</option>
                                            <option value="1" @if($role->is_active == 1) selected @endif>Active</option>
                                            <option value="0" @if($role->is_active == 0) selected @endif>Inactive</option>
                                        </select>
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                                                        ...
                                                                        @if($module->key != $sub_module_permission->key)
                                                                            <div class="col-md-4 p-2">
                                                                                ...
                                                                                <label class="form-check form-switch form-check-custom form-check-solid me-2">
                                                                                    <input class="form-check-input sub-module-check" type="checkbox" value="{{ $sub_module_permission->id }}" name="permission[]"
                                                                                           @php $j=0; @endphp
                                                                                           @foreach($role->permission as $role_permission)
